...
function frameOne() {
    ...
    var tl = gsap.timeline();
        tl
	.from("#f1_txt1", {scale:2.5, opacity:0, duration:0.5,  ease:"elastic.out(0.7, 0.6)", transformOrigin:"50% 70%"})
...
function frameTwo() {
	...
	.from("#f2_txt1", {scale:2.5, opacity:0, duration:0.5,  ease:"elastic.out(0.7, 0.6)", transformOrigin:"50% 70%"})
...
function frameThree() {
	...
	.from("#f3_txt1", {scale:2.5, opacity:0, duration:0.5,  ease:"elastic.out(0.7, 0.6)", transformOrigin:"50% 70%"})
...
function endFrame() {
    ...
    var tl = gsap.timeline();
		...
		.from("#ef_txt1", {scale:2.5, opacity:0, duration:0.5,  ease:"elastic.out(0.7, 0.6)", transformOrigin:"50% 70%"})
