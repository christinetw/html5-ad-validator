...
function frameOne() {
    ...
    var tl = gsap.timeline();
        tl
	.from("#f1_txt1", {scale:2.5, opacity:0, duration:0.5,  ease:"elastic.out(0.7, 0.6)", transformOrigin:"727px 106px"})
...
function frameTwo() {
    ...
    var tl = gsap.timeline();
        tl
	.to(["#product1","#product2"], {x:"-=485", ease:"power2.inOut", duration:0.8})
	.from("#f2_txt1", {scale:2.5, opacity:0, duration:0.5,  ease:"elastic.out(0.7, 0.6)", transformOrigin:"727px 106px"})
...
function frameThree() {
    ...
    var tl = gsap.timeline();
        tl
	.to(["#product2"], {x:"-=485", ease:"power2.inOut", duration:0.8})
	.to(["#product3"], {x:"-=485", ease:"power2.inOut", duration:0.8},'<')
	.from("#f3_txt1", {scale:2.5, opacity:0, duration:0.5,  ease:"elastic.out(0.7, 0.6)", transformOrigin:"727px 106px"})
...
function endFrame() {
    ...
    var tl = gsap.timeline();
        tl
		.to(["#product3"], {x:"-=485", ease:"power2.inOut", duration:0.8})
		.to(["#product4"], {x:"-=485", ease:"power2.inOut", duration:0.8},'<')
		.from("#ef_txt1", {scale:2.5, opacity:0, duration:0.5,  ease:"elastic.out(0.7, 0.6)", transformOrigin:"727px 106px"})
		.to("#logo", {x:-150, ease:"power2.inOut", delay:3})
		.from("#cta-line", {scaleY:0, ease:"power3.inOut"})
		.from([".cta-logo"], {x:"-=90", stagger:0.5, autoAlpha:0})
