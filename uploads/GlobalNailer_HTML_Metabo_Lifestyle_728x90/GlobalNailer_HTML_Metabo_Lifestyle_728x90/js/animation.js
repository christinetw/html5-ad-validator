...
function frameOne() {
    ...
    var tl = gsap.timeline();
        tl
	.from("#f1_txt1", {scale:2.5, opacity:0, duration:0.5,  ease:"elastic.out(0.7, 0.6)", transformOrigin:"410px 50%"})
...
function frameTwo() {
    ...
    var tl = gsap.timeline();
        tl
	.to(["#product1","#product2"], {x:"-=230", ease:"power2.inOut", duration:0.8})
	.from("#f2_txt1", {scale:2.5, opacity:0, duration:0.5,  ease:"elastic.out(0.7, 0.6)", transformOrigin:"410px 50%"})
...
function frameThree() {
    ...
    var tl = gsap.timeline();
        tl
	.to(["#product2"], {x:"-=230", ease:"power2.inOut", duration:0.8})
	.to(["#product3"], {x:"-=230", ease:"power2.inOut", duration:0.8},'<')
	.from("#f3_txt1", {scale:2.5, opacity:0, duration:0.5,  ease:"elastic.out(0.7, 0.6)", transformOrigin:"410px 50%"})
...
function endFrame() {
    ...
    var tl = gsap.timeline();
        tl
		.to(["#product3"], {x:"-=230", ease:"power2.inOut", duration:0.8})
		.to(["#product4"], {x:"-=230", ease:"power2.inOut", duration:0.8},'<')
		.from("#ef_txt1", {scale:2.5, opacity:0, duration:0.5,  ease:"elastic.out(0.7, 0.6)", transformOrigin:"410px 50%"})
		.to("#logo", {y:-20, ease:"power2.inOut", delay:3})
		.from("#cta-line", {scaleY:0, ease:"power3.inOut"})
		.from([".cta-logo"], {y:"-=9", stagger:0.5, autoAlpha:0})
