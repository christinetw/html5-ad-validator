...
function frameTwo() {
	...
	gsap.from(["#product2"], {x:"+=260", rotation:-10, y:"+=30", ease:"power4.inOut", duration:1}, 0.75)
...
function frameThree() {
	...
	gsap.from(["#product3"], {x:"+=270", rotation:-10, y:"+=30", ease:"power4.inOut", duration:1}, 0.75)
...
function endFrame() {
    ...
    var tl = gsap.timeline();
        tl
	.from("#ef_txt1", {scale:2.5, opacity:0, ease:"power2.out", duration:0.5,  ease:"elastic.out(0.7, 0.6)", delay:0.5, transformOrigin:"50% 448px"})
	.to("#logo", {y:-63, ease:"power2.inOut", delay:0.5})
	.from("#cta-line", {scaleY:0, ease:"power3.inOut"})
	.from([".cta-logo"], {y:-11, stagger:0.5, autoAlpha:0})
